export default function RegisterBusinessValidation({ email, name, password, passwordConfirm, phoneNumber, birthYear, birthMonth, birthDay }, isFirst, errors) {
  // 사업자 등록증에 대한 validation 추가 필요
  if (!isFirst.email) {
    if (!email) {
