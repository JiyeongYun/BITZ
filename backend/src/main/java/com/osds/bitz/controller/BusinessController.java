...
public class BusinessController {
    ...
    public ResponseEntity<ArrayList<Game>> readGameList(@ApiParam(value = "회원 정보") @RequestParam(value = "email") String email, @RequestParam(value = "date") Date date) throws Exception {
