...
public class UserController {
    ...
    public ResponseEntity<UserAuthResponse> createUser(@RequestBody @ApiParam(value = "회원 정보") UserAuthRequest userAuthRequest) {
    ...
    public ResponseEntity<UserAuthResponse> isDuplicatedEmail(@RequestBody @ApiParam(value = "회원 정보") UserAuthRequest userAuthRequest) {
    ...
    public ResponseEntity<UserAuthResponse> isDuplicatedNickname(@RequestBody @ApiParam(value = "회원 정보") UserAuthRequest userAuthRequest) {
    ...
    public ResponseEntity<UserAuthResponse> readUser(@RequestBody @ApiParam(value = "회원 정보") ReadAuthRequest readAuthRequest) {
    ...
    public ResponseEntity<UserAuthResponse> readLoginLog(@RequestBody @ApiParam(value = "이메일") ReadAuthRequest readUAuthRequest) {
    ...
    public ResponseEntity<UserResponse> createProfile(@RequestBody @ApiParam(value = "회원 정보") UserRequest userRequest) {
    ...
    public ResponseEntity<UserResponse> readProfile(@ApiParam(value = "회원 정보") @RequestParam(value = "email") String email) {
    ...
    public ResponseEntity<UserResponse> updateProfile(@RequestBody @ApiParam(value = "마이페이지 정보") UserRequest userRequest) {
    ...
    public ResponseEntity<UserAuthResponse> updatePassword(@RequestBody @ApiParam(value = "회원 정보") UpdatePasswordRequest updatePasswordRequest) {
    ...
    public ResponseEntity<UserAuthResponse> resetPassword(@RequestBody @ApiParam(value = "이메일") UserAuthRequest userAuthRequest) {
        UserAuth userAuth = userService.resetPassword(userAuthRequest.getEmail());
    ...
    public ResponseEntity deleteUser(@RequestBody @ApiParam(value = "회원탈퇴") ReadAuthRequest readAuthRequest) {
